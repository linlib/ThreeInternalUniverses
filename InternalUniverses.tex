...
\begin{center}
  ...
  \begin{center}
  \ \\
  \scalebox{1.5}{\texttt{Internal Universes}}
  \ \\
  \end{center}
  \end{tcolorbox}
  \end{center}
...
\hline
 & \\
\hline \hline
\multicolumn{2}{||c||}{\texttt{Chapter 5: } Monadicity D(O...), D(∞-Grpd), and D(∞-Grpd⁄X) ⇄ D(∞-Grpd⁄Y)} \\
\hline \hline
 & \\
\hline
 & \\
\hline \hline
\multicolumn{2}{||c||}{\texttt{Chapter 6: } Monadicity D(O...), D(∞-Cat), and D(∞-Cat⁄C) ⇄ D(∞-Cat⁄D)} \\
\hline \hline
 & \\
\hline
 & \\
...
\iffalse
https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Monad/Monadicity.html
https://leanprover-community.github.io/mathlib4_docs/Mathlib/CategoryTheory/Monad/Basic.html
\fi
